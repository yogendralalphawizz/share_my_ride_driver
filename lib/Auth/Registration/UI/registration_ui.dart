...
import 'package:smr_driver/Api/constant.dart';
import 'package:smr_driver/Auth/BankDetails/UI/bank_details_page.dart';
import 'package:smr_driver/Auth/Verification/UI/verification_page.dart';
...
import 'package:smr_driver/Model/cab_model.dart';
                  ...
                  children: [
                    ...
                    Container(
                      child: Padding(
                        ...
                        child: Text(
                          getTranslated(context, "UPLOAD_Drive")!,
                    ...
                    Container(
                      child: Padding(
                        padding: const EdgeInsets.only(left: 20, right: 20),
                        child: Text(
                          getTranslated(context, "UPLOAD_PASS")!,
                          style: TextStyle(color: Colors.black),
                        ),
                      ),
                    ),
                    ...
                    Container(
                      child: Padding(
                        padding: const EdgeInsets.only(left: 20, right: 20),
                        child: Text(
                          getTranslated(context, "UPLOAD_BLUE")!,
                          style: TextStyle(color: Colors.black),
                        ),
                      ),
                    ),
                    ...
                    Container(
                      child: Padding(
                        padding: const EdgeInsets.only(left: 20, right: 20),
                        child: Text(
                          getTranslated(context, "UPLOAD_INS")!,
                          style: TextStyle(color: Colors.black),
                        ),
                      ),
                    ),
                    ...
                    Container(
                      child: Padding(
                        padding: const EdgeInsets.only(left: 20, right: 20),
                        child: Text(
                          getTranslated(context, "UPLOAD_BANK")!,
                          style: TextStyle(color: Colors.black),
                        ),
                      ),
                    ),
                    ...
                    //     padding: const EdgeInsets.only(left: 20, right: 20),
                    //     child: Text(
                    //       getTranslated(context, "UPLOAD_VEHICLE")!,
                    //       style: TextStyle(color: Colors.black),
                    //     ),
                    //   ),
                    // ),
                    ...
                    Container(
                      child: Padding(
                        padding: const EdgeInsets.only(left: 20, right: 20),
                        child: Text(
                          getTranslated(context, "UPLOAD_ADHAR")!,
                          style: TextStyle(color: Colors.black),
                        ),
                      ),
                    ),
                    ...
                    Container(
                      child: Padding(
                        padding: const EdgeInsets.only(left: 20, right: 20),
                        child: Text(
                          getTranslated(context, "UPLOAD_AADHAR")!,
                          style: TextStyle(color: Colors.black),
                        ),
                      ),
                    ),
                    ...
                    Container(
                      child: Padding(
                        padding: const EdgeInsets.only(left: 20, right: 20),
                        child: Text(
                          getTranslated(context, "UPLOAD_RC")!,
                          style: TextStyle(color: Colors.black),
                        ),
                      ),
                    ),
...
//       Map<Permission, PermissionStatus> statuses = await [Permission.camera, Permission.storage,
//       ].request();
    ...
    if (result != null) {
      setState(() {
        if(i==1){
          ...
          vehicleImage = File(result.files.single.path.toString());
        }else if(i==3){
          adharImage = File(result.files.single.path.toString());
        }
        else if(i==6){
          insuranceImage = File(result.files.single.path.toString());
        }
        else if(i==7){
          bankImage = File(result.files.single.path.toString());
        }
        else if(i==8){
          adharBackImage = File(result.files.single.path.toString());
        }
        else if(i==9){
          adharFrontImage = File(result.files.single.path.toString());
        }
        else if(i==10){
          rcImage = File(result.files.single.path.toString());
        }
        else {
          _finalImage = File(result.files.single.path.toString());
        }
      });
      Navigator.pop(context);
      // setState(() {
  ...
  void getCropImage(BuildContext context, int i, var image) async {
    ...
    setState(() {
      if (i == 1) {
        ...
        adharBackImage = File(croppedFile!.path);
      }
      else if(i==9){
        adharFrontImage = File(croppedFile!.path);
      }
      else if(i==10){
      ...
      try {
        if (_image != null) {
          ...
          request.files.add(
            http.MultipartFile(
              'aadhar_back',
              adharBackImage!.readAsBytes().asStream(),
              adharBackImage!.lengthSync(),
              filename: path.basename(adharBackImage!.path),
              contentType: MediaType('image', 'jpeg'),
            ),
          );
          request.files.add(
            http.MultipartFile(
              'aadhar_front',
              adharFrontImage!.readAsBytes().asStream(),
              adharFrontImage!.lengthSync(),
              filename: path.basename(adharFrontImage!.path),
              contentType: MediaType('image', 'jpeg'),
            ),
          );
          request.files.add(
