...
class NotificationModel1 {
  ...
  NotificationModel1({this.title, this.message, this.bookingId});
...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  bool loading = true;
  List<NotificationModel1> notificationList = [];
      ...
      try {
        ...
        if (response['status']) {
          for (var v in response['data']) {
            setState(() {
              notificationList.add(new NotificationModel1.fromJson(v));
            });
          }
        } else {}
  ...
  Widget build(BuildContext context) {
    ...
    //     .message
    //     .toString()}"+"_____________________-");
