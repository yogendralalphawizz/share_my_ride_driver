...
import 'package:smr_driver/DrawerPages/Wallet/send_to_bank_page.dart';
import 'package:smr_driver/Locale/strings_enum.dart';
import 'package:smr_driver/Locale/locale.dart';
import 'package:smr_driver/Model/wallet_model.dart';
...
import 'package:smr_driver/utils/Razorpay.dart';
                        ...
                        ? Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    print("Wallet AMounttttt ${amount.text}");
                                    RazorPayHelper razorPay = new RazorPayHelper(amount.text, context,
                                            (result) {
                                          print("walletttt Result ${result}");
                                      if (result != "error") {
                                        addWallet(result);
                                      } else {
                                        setState(() {
